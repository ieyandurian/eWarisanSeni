				...
				<div class="row-fluid">
					...
					<div class="span9">
						<div id="content">
							...
							<%@page import="com.EQCSYS.app.servlet.RegisterServlet"%>
							<jsp:useBean id="obj"
								class="com.EQCSYS.app.bean.CustomerBean" />

							<jsp:setProperty property="*" name="obj" />

							<%
								out.print("You are successfully registered. <br> Please login to use our system to its full potential.");
							%>
						</div>
					</div>
					<div class="span3">
