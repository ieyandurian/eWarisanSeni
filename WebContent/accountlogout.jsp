					...
					<div class="span9">
						<div id="content">
							<div class="breadcrumb">
								...
								&raquo; <a href="accountlogout.jsp">Account Logout</a>
							</div>
							<h1>Account Logout</h1>
							<p>You have been logged off your account. It is now safe to
								leave the computer.</p>
							<p>Your shopping cart has been emptied, the items inside it
								will be gone as you never proceed to checkout.</p>
							<div class="buttons">
								<div class="right">
