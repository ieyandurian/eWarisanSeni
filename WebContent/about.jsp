					...
					<div class="span12">
						<div id="content">
							<div class="breadcrumb">
								<a href="home.jsp">Home</a> &raquo; <a href="about.jsp">About
									Us</a>
							</div>
							<h1>About Us</h1>
							<p>Our company has been operating for more than 20 years on a
								small scale. The company was officially registered at the
								Suruhanjaya Syarikat Malaysia in 1996 in favor of private, Haji
								Kasim Haji Limat briefed on the name of our&nbsp;company
								founder. Our company changed its name to Warisan Seni Haji Kasim
								Enterprise in 2007 for the purpose of commercialization and
								expansion of our company.</p>

							<p>&nbsp;</p>

							<p>
								We have five permanent workers that were skilled and
								experienced. We supply our products all over Melaka and around
								Malaysia like Kuala Lumpur, Johor, Kelantan, Perak and Penang.
								Our clients range from schools, individuals and <em>kompang</em>
								associations.
							</p>
							...
							<p>
								Additionally, our company registered with Kraftangan Malaysia
								Cawangan Melaka. We&nbsp;created a wide range of traditional
								Malay musical instrument like&nbsp;<em>kompang</em>, <em>rebana</em>,
								Jidur and <em>gendang silat</em>. We also supply other musical
								instruments such as gong, <em>caklempong</em>, <em>tamborin</em>
								and <em>kompang kerincing</em>.
							</p>

							<hr />
							<p>The owner of Warisan Seni Haji Kasim Enterprise
								is&nbsp;Mr. Shabri Bin Kasim. He manages the company by hire
								manager and&nbsp;an assistant manager to lead the other workers.</p>

							<p>
								<strong>The Organizational Structure of Warisan Seni
									Haji Kasim Enterprise</strong>
							</p>

							<p>
								<img alt="" src="image/data/org-struct.jpg"
									style="width: 591px; height: 342px;" />
							</p>
							<hr />
							<p>
								<img alt="" src="image/data/map.jpg"
									style="width: 624px; height: 253px;" />
							</p>
							<br />
							<div class="buttons">
								<div class="right">
									<a href="home.jsp" class="button">Continue</a>
								</div>
							</div>
						</div>
					</div>
