					...
					<div class="span9">
						<div id="content">
							<div class="breadcrumb">
								...
								&raquo; <a href="login.jsp">Login</a>
							</div>
									...
									<div class="span6">
										<div class="inner">
											...
											<div class="content">
												...
												<a href="register.jsp" class="button">Continue</a>
											</div>
										</div>
									</div>
									<div class="span6">
										<div class="inner">
											...
											<form action="login" enctype="multipart/form-data">
												<div class="content">
													...
													<b>Username :</b><br /> <input type="text" name="un"
														value="" /> <br /> <br /> <b>Password:</b><br /> <input
														type="password" name="pw" value="" /> <br /> <a
														href="forgotten.jsp">Forgotten Password</a><br /> <br />
