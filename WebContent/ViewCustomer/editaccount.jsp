...
<script>
	function validateAccount() {
		...
		var email = document.acc.cust_email.value;
		var atposition=email.indexOf("@");  
		var dotposition=email.lastIndexOf("."); 
		var first = document.acc.cust_firstname.value;
		var last = document.acc.cust_lastname.value;
		var icnum = document.acc.cust_icnum.value;
		var pnum = document.acc.cust_phonenumber.value;
		...
		if (!/^[a-z A-Z]*$/g.test(first)) {
			alert("Please insert first name in letters");
			return false;
		}
		
		if (!/^[a-z A-Z]*$/g.test(last)) {
			alert("Please insert last name in letters");
			return false;
		}
		if (isNaN(icnum)) {
			alert("Ic number cannot be in letter");
			return false;
		}
		
		if (icnum.length < 12 || icnum.length > 12) {
			alert("Ic number length is incorrect");
			return false;
		}
		if (isNaN(pnum)) {
			alert("Phone cannot be in letter");
			return false;
		}
									...
									<div class="mini-cart-info">
										<table>
											<%
												...
												HashMap<Integer, Integer> items = cart.getCartItems();
						...
						<div id="content">
							<div class="breadcrumb">
								<a href="ViewCustomer/home.jsp">Home</a> &raquo; <a
									href="ViewCustomer/account.jsp">Account</a> &raquo; <a
									href="ViewCustomer/editaccount.jsp">Edit Information</a>
							</div>
							<h1>My Account Information</h1>
							<form name="acc" action="account" onsubmit="return validateAccount()">
								...
								<div class="buttons">
									<div class="left">
										<a href="ViewCustomer/account.jsp" class="button">Back</a>
									</div>
									<div class="right">
							...
							<div class="box">
								...
								<div class="box-content">
									<ul>
										...
										<li><a href="ViewCustomer/editaccount.jsp">Edit
												Account</a></li>
