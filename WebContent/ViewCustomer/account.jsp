				...
				<div class="row-fluid">
					...
					<div class="span9">
						<div id="content">
							...
							<div class="content">
								<ul>
									<li><a href="ViewCustomer/editaccount.jsp">Edit your account
											information</a></li>
									<li><a href="ViewCustomer/updatepassword.jsp">Change your password</a></li>
									<li><a href="ViewCustomer/address.jsp">Modify your address book
											entries</a></li>
							...
							<div class="content">
								<ul>
									<li><a href="ViewCustomer/orderhistory.jsp">View your order history</a></li>
								</ul>
							</div>
						</div>
					</div>
