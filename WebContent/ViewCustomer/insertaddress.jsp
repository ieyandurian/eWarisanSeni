						...
						<div id="content">
							<div class="breadcrumb">
								...
								&raquo; <a href="ViewCustomer/address.jsp">Address Book</a> &raquo; <a
									href="ViewCustomer/insertaddress.jsp">Add New Address</a>
							</div>
							<h1>Address Book</h1>
							<form name="insert" action="insertAddress" enctype="multipart/form-data" onsubmit="return validateInsertAddress()">
							...
							<div class="box">
								...
								<div class="box-content">
									<ul>
										...
										<li><a href="ViewCustomer/editaccount">Edit Account</a></li>
