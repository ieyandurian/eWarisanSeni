					...
					<div class="span9">
						<div id="content">
							<div class="breadcrumb">
								...
								&raquo; <a href="ViewCustomer/editaccount.jsp">Edit Information</a>
							</div>
							<h1>My Account Information</h1>
							<form action="ViewCustomer/account.jsp">
								<h2>Your Personal Details</h2>
								
								<h3>Your Personal Details is updated</h3>
								<div class="content">
									<table class="form">
