...
<script type="text/javascript">
	function matchpass() {
		var firstpassword = document.pass.newcust_password.value;
		var secondpassword = document.pass.concust_password.value;
					...
					<div class="span9">
						<div id="content">
							<div class="breadcrumb">
								...
								&raquo; <a href="ViewCustomer/updatepassword.jsp">Change Password</a>
							</div>
							<h1>Change Password</h1>
							<form name="pass" action="password" onsubmit="matchpass()">
								<h2>Your Password</h2>
								<div class="content">
									<table class="form">
										<tr>
											<td><span class="required">*</span> New Password:</td>
											<td><input type="password" name="newcust_password"
												value="" required/></td>
										</tr>
										<tr>
											<td><span class="required">*</span> Confirm New
												Password:</td>
											<td><input type="password" name="concust_password"
												value="" required/></td>
										</tr>
									</table>
								</div>
