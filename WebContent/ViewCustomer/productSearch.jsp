			...
			<div class="container">
				<div class="row-fluid">
					...
					<div>
											...
											<div class="row-fluid">
												...
												<div class="product-block span3">
													<div class="product-inner">
														...
														<div class="image">
															<a href="ViewCustomer/productdetails.jsp?prod_ID=1"><img
																src="image/cache/data/kompang-75x62.JPG"
																title="Traditional Kompang" alt="Traditional Kompang" /></a>
														</div>
														<div class="name">

															<a href="ViewCustomer/productdetails.jsp?prod_ID=1">Traditional
																Kompang</a>
														</div>
												...
												<div class="product-block span3">
													<div class="product-inner">
														...
														<div class="image">
															<a href="ViewCustomer/productdetails.jsp?prod_ID=2"><img
																src="image/cache/data/rebana-75x62.JPG"
																title="Percussion (Rebana)" alt="Percussion (Rebana)" /></a>
														</div>
														<div class="name">

															<a href="ViewCustomer/productdetails.jsp?prod_ID=2">Percussion
																(Rebana)</a>
														</div>
												...
												<div class="product-block span3">
													<div class="product-inner">
														...
														<div class="image">
															<a href="ViewCustomer/productdetails.jsp?prod_ID=3"><img
																src="image/cache/data/kompang-x-ray-75x62.jpg"
																title="X-Ray Kompang" alt="X-Ray Kompang" /></a>
														</div>
														<div class="name">

															<a href="ViewCustomer/productdetails.jsp?prod_ID=3">X-Ray Kompang</a>
														</div>
						...
						<%
							ProductBean prod = ((ProductBean) (session
						...
						<div class="span9">
							<div id="content">
								...
								select * from product where lower(prod_name) like '%<%= prod.getProd_SearchName()%>%' or upper(prod_name) like '%<%= prod.getProd_SearchName()%>%'
								</sql:query>
														...
														<div class="price-cart">
															...
															<div class="cart1">
																<br> <input type="hidden" name="prod_ID"
																	...
																	href="ViewCustomer/productdetails.jsp?prod_ID=<c:out value="${row.prod_ID}" />"><input
