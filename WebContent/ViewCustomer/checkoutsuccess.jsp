						...
						<div id="content">
							<div class="breadcrumb">
								<a href="ViewCustomer/home.jsp">Home</a> &raquo; <a href="ViewCustomer/cart.jsp">Shopping
									Cart</a> &raquo; <a href="ViewCustomer/checkout.jsp">Checkout</a> &raquo; <a
									href="ViewCustomer/checkoutsuccess.jsp">Success</a>
							</div>
							<h1>Your Order Has Been Processed!</h1>
							<p>Your order has been successfully processed!</p>
							<p>
								You can view your order history by going to the <a
									href="ViewCustomer/account.jsp">my account</a> page and by clicking on <a
									href="ViewCustomer/orderhistory.jsp">history</a>.
							</p>
							<p>
								Please direct any questions you have to the <a
									href="mailto:admin@warisanseni.com">store owner</a>.
							</p>
