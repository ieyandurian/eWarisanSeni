					...
					<div class="span9">
						...
						<div id="content">
							<div class="breadcrumb">
								...
								&raquo; <a href="ViewCustomer/address.jsp">Address Book</a>
							</div>
							<h1>Address Book</h1>
							<sql:setDataSource var="snapshot"
								driver="oracle.jdbc.driver.OracleDriver"
						...
						+ currentUser.getCust_lastname()%>,</b></td>
							...
							<div class="buttons">
								...
								<div class="right">
									<a href="ViewCustomer/insertaddress.jsp" class="button">New Address</a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="box">
								...
								<div class="box-content">
									<ul>
										...
										<li><a href="ViewCustomer/accountlogout.jsp">Logout</a></li>
									</ul>
								</div>
							</div>
						</div>
