...
<script>
	function validateAddress() {
		...
		var city = document.ad.add_city.value;
		var postcode = document.ad.add_postcode.value;
		var state = document.ad.add_state.value;
		var country = document.ad.add_country.value;
		...
		if (!/^[a-z A-Z]*$/g.test(state)) {
			alert("Please insert state in letters");
			return false;
		}
		if (!/^[a-z A-Z]*$/g.test(country)) {
			alert("Please insert state in letters");
			return false;
		}
					...
					<div class="span9">
						<div id="content">
							<div class="breadcrumb">
								...
								&raquo; <a href="ViewCustomer/address.jsp">Address Book</a> &raquo; <a
									href="ViewCustomer/editaddress.jsp">Edit Address</a>
							</div>
							<h1>Address Book</h1>
							<sql:setDataSource var="snapshot"
								driver="oracle.jdbc.driver.OracleDriver"
							...
							<sql:param value="${param.add_id}" />
							</sql:query>
							<form name="ad" action="updateAddress"	onsubmit="return validateAddress()">
								<h2>Edit Address</h2>
								<c:forEach items="${result.rows}" var="row">
									<div class="content">
										<table class="form">
								...
								<div class="buttons">
									<div class="left">
										<a href="ViewCustomer/address.jsp" class="button">Back</a>
									</div>
									<div class="right">
